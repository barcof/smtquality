    ...
    <head>
        ...
        **/
		...
		Ext.define('rejection_store',{
			extend	: 'Ext.data.Model',
			fields	: ['rejectid', 'inputid', 'partno', 'qtyselect', 'qtyng', 'repairedby', 'howtorepair', 'checkedby', 'fld_result', 'fld_desc', 'pic', 'file_name', 'inputdate']
		});
		...
		var rejection_store = Ext.create('Ext.data.Store',{
			...
			//	Grid data
				...
				//	----***----  //
						...
						else if (<?=$_SESSION['iqrs_userlevel']?>==0 || <?=$_SESSION['iqrs_userlevel']?>==1) {
							var grid_data = Ext.create('Ext.grid.Panel', {
      ...
      // Search Serial Number for MA/FA/MECHA
